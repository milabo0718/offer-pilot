...
func InitRouter(userController *user.UserController, sessionController *session.SessionController, jwtManager *myjwt.JWTManager) *gin.Engine {
	...
	}
	{
		...
		AIRouter(aigroup, sessionController)
	}
	return r
}
